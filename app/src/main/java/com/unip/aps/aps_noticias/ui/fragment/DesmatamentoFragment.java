 ...
 */
public class DesmatamentoFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_desmatamento, container, false);
        initView(view);
        return view;
    }
    ...
    private void initView(View view){
        ...
        recyclerView = (RecyclerView) view.findViewById(R.id.rv_desmatamento);
